...
class RelatedPlaylists {
  ...
  factory RelatedPlaylists.fromJson(Map<String, dynamic> json) =>
      RelatedPlaylists(
        likes: json["likes"],
        favorites: json["favorites"] ?? 'Not find',
        uploads: json["uploads"],
        watchHistory: json["watchHistory"]??'Not find',
        watchLater: json["watchLater"]??'Not find',
      );
...
class Statistics {
  ...
  factory Statistics.fromJson(Map<String, dynamic> json) => Statistics(
        viewCount: json["viewCount"]??'Not find',
        commentCount: json["commentCount"]??'Not find',
        subscriberCount: json["subscriberCount"]??'Not find',
        hiddenSubscriberCount: json["hiddenSubscriberCount"]??'Not find',
        videoCount: json["videoCount"]??'Not find',
      );
