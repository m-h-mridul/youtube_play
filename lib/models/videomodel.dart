...
class Thumbnails {
 ...
 // Default thumbnailsDefault;
  ...
  //           ? Default.empty(empaty: 'empty')
  //           : Default.fromJson(json["standard"]??'Not find'),
  //       maxres: '' == json["maxres"] ? Default.empty(empaty: 'empty') : Default.fromJson(json["maxres"]),
  //     );
  Map<String, dynamic> toJson() => {
